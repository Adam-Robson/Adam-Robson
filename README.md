...
[![linkedin icon](/assets/icons/linkedin8355835.jpg "LinkedIn: Adam Robson")](https://www.linkedin.com/in/adamrayrobson/)    [![spotify icon](/assets/icons/spotify2424.png "Spotify: LE FOG")](https://open.spotify.com/artist/4NrRxIaVhlouvojuHGq62y)
...
![Python icon](/assets/icons/python.png "Python")     ![react icon](/assets/icons/react.png "React")    ![javascript icon](assets/icons/.js.png "JavaScript")    ![express icon](/assets/icons/express.png "Express")      ![postgresql icon](/assets/icons/psql.png "PostgreSQL")   ![nodejs icon](/assets/icons/node.png "nodejs")
